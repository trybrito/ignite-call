...
const timeIntervalsFormSchema = z.object({
  intervals: z
    ...
    .refine((intervals) => intervals.length > 0, {
      message: 'É necessário informar, pelo menos, 1 dia da semana',
    })
    .transform((intervals) => {
    ...
    .refine(
      ...
      {
        message:
          'O horário de término deve ocorrer, pelo menos, 1 hora após o horário de início',
      },
    ),
})
...
export default function TimeIntervals() {
  ...
  async function handleSetTimeIntervals(formData: TimeIntervalsFormOutput) {
    console.log(formData.intervals)
  }
